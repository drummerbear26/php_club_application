        ...
        <div id="wrap">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
				...
				<fieldset id="instrument">
					...
					<textarea rows="3" cols="22" name="instrument" placeholder="Enter instrument(s)" required></textarea>
					<!--<input type="textarea" name="instrument" id="instrument" placeholder="Enter instrument(s)" require="true" tabindex="17" value="<?php htmlspecialchars($instrument); ?>"/>-->
					<span class="error">* <?php echo $instrument_err; ?></span>
					<br /><br />
					<label for="ownInstrument">Do you own your own musical instrument?</label><br />
					<input id="ownInstrument" type="radio" name="ownInstrument" value="Yes" <?php if (isset($ownInstrument) && $ownInstrument == "Yes") echo "checked"; ?> require="true" tabindex="18" /><label> Yes</label><br />
						<div class="reveal_if_active">
							<label for="">Please enter:</label><br />
							<label for="make">Make: <input id="make" type="text" name="make" placeholder="Enter Make" tabindex="20" value="<?php echo htmlspecialchars($make); ?>" />
							</label><br />
							<label for="model">Model: <input id="model" type="text" name="model" placeholder="Enter Model" tabindex="21" value="<?php echo htmlspecialchars($model); ?>" />
							</label><br />
							<label for="serialNumber">Serial number: <input id="serialNumber" type="text" name="serialNumber" placeholder="Enter Serial Number" tabindex="22" value="<?php echo htmlspecialchars($serialNumber); ?>" />
							</label><br /><br />
						</div>
					<label><input id="ownInstrument" type="radio" name="ownInstrument" value="No" <?php if(isset($ownInstrument) && $ownInstrument == "No") echo "checked"; ?> tabindex="19" /> No</label>
					<span class="error">* <?php echo $ownInstrument_err; ?></span>
					<br /><br />
			
					<label for="stand">Do you have a portable music stand?</label><br />
					<label><input id="stand" type="radio" name="stand" value="Yes"<?php if(isset($stand) && $stand =="Yes") echo "checked"; ?> tabindex="23" /> Yes</label><br />
					<label><input id="stand" type="radio" name="stand" value="No" <?php if(isset($stand) && $stand == "No") echo "checked"; ?> tabindex="24" /> No</label>
					<span class="error">* <?php echo $stand_err; ?></span>
					<br /><br />
				</fieldset>
				<fieldset id="acknowledgement">
					<legend>Acknowledgement:</legend>
					<label for="agree"><input id="agree" type="checkbox" name="agree" require="true" tabindex="25" value="agree" <?php if(isset($agree) && $agree == "agree") echo "checked"; ?> By checking this box, you agree to the following: </label>
